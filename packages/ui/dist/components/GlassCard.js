...
export const GlassCard = ({ children, className = '', variant = 'default' }) => {
    ...
    return (React.createElement(motion.div, { variants: glassVariants, initial: "initial", animate: "animate", exit: "exit", className: `rounded-2xl ${glassStyles[variant]} ${className}` }, children));
};
