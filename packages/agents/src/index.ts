import { Agent, AgentSpecialty, AgentStatus } from "@careerate/types";

export const TerraAgent: Agent = {
  id: 'terra',
  name: 'Terra',
...
export const agents: Agent[] = [TerraAgent, KubeAgent, CloudAgent, RapidAgent]; 